...
// ItemLegal_holdsStatsRequestBuilder builds and executes requests for operations under \companies\{company_id-id}\legal_holds\stats
...
func NewItemLegal_holdsStatsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemLegal_holdsStatsRequestBuilder) {
    m := &ItemLegal_holdsStatsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/companies/{company_id%2Did}/legal_holds/stats", pathParameters),
    }
    return m
}
...
// Get show legal hold stats for a company
...
// ToGetRequestInformation show legal hold stats for a company
