...
type ItemMattersPostRequestBody struct {
...
// NewItemMattersPostRequestBody instantiates a new ItemMattersPostRequestBody and sets the default values.
func NewItemMattersPostRequestBody()(*ItemMattersPostRequestBody) {
    m := &ItemMattersPostRequestBody{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemMattersPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateItemMattersPostRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewItemMattersPostRequestBody(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *ItemMattersPostRequestBody) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetBusinessUnit gets the business_unit property value. The business_unit property
// returns a *string when successful
func (m *ItemMattersPostRequestBody) GetBusinessUnit()(*string) {
    return m.business_unit
}
// GetCaption gets the caption property value. The caption property
// returns a *string when successful
func (m *ItemMattersPostRequestBody) GetCaption()(*string) {
    return m.caption
}
// GetDateCreated gets the date_created property value. The date_created property
// returns a *Time when successful
func (m *ItemMattersPostRequestBody) GetDateCreated()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    return m.date_created
}
// GetDateEnd gets the date_end property value. The date_end property
// returns a *Time when successful
func (m *ItemMattersPostRequestBody) GetDateEnd()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    return m.date_end
}
// GetDateModified gets the date_modified property value. The date_modified property
// returns a *Time when successful
func (m *ItemMattersPostRequestBody) GetDateModified()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    return m.date_modified
}
// GetDateStart gets the date_start property value. The date_start property
// returns a *Time when successful
func (m *ItemMattersPostRequestBody) GetDateStart()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    return m.date_start
}
// GetDepartment gets the department property value. The department property
// returns a *string when successful
func (m *ItemMattersPostRequestBody) GetDepartment()(*string) {
    return m.department
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *ItemMattersPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
// returns a *string when successful
func (m *ItemMattersPostRequestBody) GetName()(*string) {
    return m.name
}
// GetNotes gets the notes property value. The notes property
// returns a *string when successful
func (m *ItemMattersPostRequestBody) GetNotes()(*string) {
    return m.notes
}
// GetNumber gets the number property value. The number property
// returns a *string when successful
func (m *ItemMattersPostRequestBody) GetNumber()(*string) {
    return m.number
}
// Serialize serializes information the current object
func (m *ItemMattersPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ItemMattersPostRequestBody) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetBusinessUnit sets the business_unit property value. The business_unit property
func (m *ItemMattersPostRequestBody) SetBusinessUnit(value *string)() {
    m.business_unit = value
}
// SetCaption sets the caption property value. The caption property
func (m *ItemMattersPostRequestBody) SetCaption(value *string)() {
    m.caption = value
}
// SetDateCreated sets the date_created property value. The date_created property
func (m *ItemMattersPostRequestBody) SetDateCreated(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.date_created = value
}
// SetDateEnd sets the date_end property value. The date_end property
func (m *ItemMattersPostRequestBody) SetDateEnd(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.date_end = value
}
// SetDateModified sets the date_modified property value. The date_modified property
func (m *ItemMattersPostRequestBody) SetDateModified(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.date_modified = value
}
// SetDateStart sets the date_start property value. The date_start property
func (m *ItemMattersPostRequestBody) SetDateStart(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.date_start = value
}
// SetDepartment sets the department property value. The department property
func (m *ItemMattersPostRequestBody) SetDepartment(value *string)() {
    m.department = value
}
// SetName sets the name property value. The name property
func (m *ItemMattersPostRequestBody) SetName(value *string)() {
    m.name = value
}
// SetNotes sets the notes property value. The notes property
func (m *ItemMattersPostRequestBody) SetNotes(value *string)() {
    m.notes = value
}
// SetNumber sets the number property value. The number property
func (m *ItemMattersPostRequestBody) SetNumber(value *string)() {
    m.number = value
}
type ItemMattersPostRequestBodyable interface {
