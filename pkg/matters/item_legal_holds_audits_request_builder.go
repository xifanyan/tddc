...
// ItemLegal_holdsAuditsRequestBuilder builds and executes requests for operations under \matters\{matter_id}\legal_holds\audits
...
func NewItemLegal_holdsAuditsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemLegal_holdsAuditsRequestBuilder) {
    m := &ItemLegal_holdsAuditsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/matters/{matter_id}/legal_holds/audits", pathParameters),
    }
    return m
}
...
// Get list legal hold status audits in a matter
...
// ToGetRequestInformation list legal hold status audits in a matter
